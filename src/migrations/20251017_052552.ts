...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "_tasks_v" (
  	...
  	"version_task_assignee_id" uuid,
  	"version_task_profile_id" uuid,
  ...
  ALTER TABLE "tasks" ADD CONSTRAINT "tasks_task_profile_id_profiles_id_fk" FOREIGN KEY ("task_profile_id") REFERENCES "public"."profiles"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_tasks_v" ADD CONSTRAINT "_tasks_v_version_task_assignee_id_users_id_fk" FOREIGN KEY ("version_task_assignee_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_tasks_v" ADD CONSTRAINT "_tasks_v_version_task_profile_id_profiles_id_fk" FOREIGN KEY ("version_task_profile_id") REFERENCES "public"."profiles"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "tasks_task_profile_idx" ON "tasks" USING btree ("task_profile_id");
  ...
  CREATE INDEX "_tasks_v_version_version_task_assignee_idx" ON "_tasks_v" USING btree ("version_task_assignee_id");
  CREATE INDEX "_tasks_v_version_version_task_profile_idx" ON "_tasks_v" USING btree ("version_task_profile_id");
