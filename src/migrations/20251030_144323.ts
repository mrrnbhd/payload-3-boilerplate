...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_orders_fulfillment_status" AS ENUM('Pending', 'Queued', 'Running', 'Purchased', 'Fulfilled', 'Error');
  ...
  CREATE TYPE "public"."enum_logs_type" AS ENUM('info', 'debug', 'warning', 'error', 'audit', 'security', 'unknown');
  CREATE TYPE "public"."enum_payload_jobs_log_task_slug" AS ENUM('inline', 'purchase-task', 'fulfillment-task', 'createCollectionExport');
  CREATE TYPE "public"."enum_payload_jobs_log_state" AS ENUM('failed', 'succeeded');
  CREATE TYPE "public"."enum_payload_jobs_task_slug" AS ENUM('inline', 'purchase-task', 'fulfillment-task', 'createCollectionExport');
  ...
  CREATE TABLE "logs" (
  	...
  	"user_agent" varchar,
  	"hook" varchar,
  	"type" "enum_logs_type" DEFAULT 'info' NOT NULL,
