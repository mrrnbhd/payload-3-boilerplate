...
export const IMAGE_SIZES = {
  ...
  mobileFullTabletHalfDesktopThird: '(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw',
  ...
  mobileFullTabletThirdDesktopQuarter: '(max-width: 640px) 100vw, (max-width: 1024px) 33vw, 25vw',
} as const
